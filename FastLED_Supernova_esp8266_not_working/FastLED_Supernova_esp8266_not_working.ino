...
uint32_t CYCLE_TIME = 3; // Time, in seconds, between auto-cycle images
...
void setup() {
      FastLED.addLeds<APA102, DATA_PIN, CLOCK_PIN >(leds, NUM_LEDS); //DATA_PIN, CLOCK_PIN after apa102, 
 //FastLED.begin(); // Allocate DotStar buffer, init SPI
